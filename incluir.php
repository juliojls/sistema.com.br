            	...
            	<form action="create.php" method="POST">
                    <div class="form-row">
                         <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" id="inputEmail4" placeholder="Digite seu Nome" name="nome">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Senha</label>
                            <input type="password" class="form-control" id="inputPassword4" placeholder="Digite a sua Senha" name="senha">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputAddress">Login</label>
                            <input type="text" class="form-control" id="inputAddress" placeholder="Seu login de acesso" name="login">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-info" value="btn-cadastrar">Cadastrar</button>
